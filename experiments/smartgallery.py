...
#
# Version: 1.54.2-beta - January 20, 2026
            ...
            for root, dirs, files in os.walk(folder_path):
                for file in files:
                    ...
                    try:
                        ...
                        cursor.execute("SELECT mtime, hash, trigger, tags FROM models WHERE id = ?", (model_id,))
                        ...
                        cursor.execute("""
                            INSERT OR REPLACE INTO models (id, type, name, path, size, hash, mtime, scanned_at, trigger, tags)
                            VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
                        """, (
                            model_id,
                            kind,
